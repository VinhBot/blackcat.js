...
// Import các files
const slashCommandBuilder = require("./module/slashCommandBuilder.js");
const commandBuilder = require("./module/commandBuilder.js");
const toRgb = require("./module/toRgb.js");
const ms = require("./module/ms.js");
// xuất module
...
class Client extends Discord.Client {
  ...
  constructor(options) {
    ...
    super(options.discordClient || {
      ...
      intents: [Discord.GatewayIntentBits.Guilds, Discord.GatewayIntentBits.GuildMessages, Discord.GatewayIntentBits.MessageContent, Discord.GatewayIntentBits.GuildMembers],
    });
    ...
    if (this.command.prefixCommand === Boolean(true)) {
      ...
      await Promise.all(fs.readdirSync(commandsPath).map(async (dir) => {
        ...
        for (let file of commands) {
          ...
          const pull = require(`${commandsPath}/${dir}/${file}`);
      ...
      for (const dir of fs.readdirSync(slashPath)) {
        ...
        for (const slashCmds of filterCommands) {
          try {
            ...
            const command = require(`${slashPath}/${dir}/${slashCmds}`);
