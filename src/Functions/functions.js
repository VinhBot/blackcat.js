...
*/
module.exports.globalFilePath = function(path) {
 ...
 */
module.exports.MessageCreate = function(client, message, prefix) {
    // thời gian hồi lệnh
...
/**
 * Xây dựng nhúng cho tin nhắn.
 */
module.exports.MessageEmbed = class extends Discord.EmbedBuilder {
    constructor (options = {}) {
        super();
 ...
 */
module.exports.ms = function(str) {
...
*/
module.exports.toButtonStyle = function(style) {
